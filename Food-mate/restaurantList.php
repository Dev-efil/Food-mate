...
?>
<title>Food-mate - List of Restaurants</title>
<!--===================== PAGE-COVER ====================-->
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
          ...
          <div class="dashboard-heading">
           <h2>restaurant <span>List</span></h2>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 content-side">
                  <div class="row">
                   <?php
                   $sql = "SELECT Restaurant_ID,Image, RName, Restaurant_info, Address, Contact_No FROM restaurant";
